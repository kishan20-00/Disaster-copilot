    ...
    <div className="flex-1 flex flex-col pt-12 overflow-y-auto px-5 pb-8 scrollbar-none justify-center animate-in fade-in duration-300">
      ...
      <div className="flex flex-col items-center text-center mt-6">
        <div className="relative mb-4 group">
          ...
          <div className="relative w-16 h-16 bg-slate-50 border border-slate-200 rounded-full flex items-center justify-center shadow-lg">
            <Shield className="w-8 h-8 text-indigo-500 animate-pulse" />
          </div>
        </div>
        <h2 className="text-xl font-black tracking-tight text-slate-900 font-sans uppercase">SafeRoute AI</h2>
        <span className="text-[10px] text-indigo-500 font-mono tracking-widest uppercase font-bold">安心避難 • Disaster Co-pilot</span>
        <p className="text-slate-500 text-xs px-4 mt-3 leading-relaxed">
      ...
      <div className="my-6 space-y-4">
        <div className="w-full flex flex-col items-center">
          ...
          />
          {authLoading === 'google' && (
            <div className="mt-2 text-[10px] text-indigo-500 font-mono flex items-center gap-1.5 animate-pulse">
