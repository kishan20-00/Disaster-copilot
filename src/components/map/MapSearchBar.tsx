...
export function MapSearchBar({ searchQuery, onSearchChange, onClearSearch, onSubmit, location, user, onSignOut }: MapSearchBarProps) {
  return (
    <div className="backdrop-blur-md bg-slate-900/85 border border-slate-800/80 rounded-2xl py-2.5 px-4 flex items-center justify-between shadow-2xl relative">
      <div className="flex items-center gap-2.5 flex-1 mr-2">
        ...
        <input
          ...
          placeholder={location ? `Search a place near ${location}…` : 'Search a place or address…'}
